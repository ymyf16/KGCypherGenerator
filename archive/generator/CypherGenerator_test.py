...
#Hope to:
#pass the list of labels within node
    ...
    #Need to change this to non-random property keys
    ...
    # @depthcontrol
    # def oC_PropertyKeyName(self, property_names, parent=None):
    #     if not property_names:
    #         raise ValueError("Property names list is empty")

    #     current = UnparserRule(name='oC_PropertyKeyName', parent=parent)
    #     self.enter_rule(current)
        
    #     # Select a random property name from the list
    #     random_property = random.choice(property_names)
        
    #     # Use UnlexerRule to set the selected property name
    #     UnlexerRule(src=random_property, parent=current)
